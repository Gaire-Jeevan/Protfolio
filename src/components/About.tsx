    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className="text-xl">
          ...
          inventore accusamus ratione soluta voluptates voluptas id illum,
          laudantium modi, similique cum esse ab eum expedita quia consequatur
          mollitia. Quas, eaque quia repudiandae similique possimus nostrum illo
          sequi error dolore libero enim? Ipsa vitae suscipit neque, repellat
          velit nisi omnis dolore!
        </p>
      </div>
    </div>
  );
